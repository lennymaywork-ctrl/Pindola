    ...
    widget.innerHTML = `
        ...
        <div id="ai-chat-window" class="chat-window hidden">
            ...
            <div id="chat-messages" class="chat-messages">
                <div class="message bot">Hello! I am an AI-powered assistant trained to help you with this business's bookings and FAQs. I am not a human host. How can I help you today?</div>
            </div>
